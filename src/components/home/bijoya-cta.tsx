...
export const BijoyaCTA: React.FC = () => {
  ...
  return (
    <section className="py-12 sm:py-20 relative overflow-hidden bg-transparent">
      ...
      >
        <div className="agomoni-card p-5 sm:p-10 md:p-14 text-center relative overflow-hidden">
          ...
          <div className="relative z-10 max-w-3xl mx-auto space-y-4 sm:space-y-6">
            <div className="inline-flex items-center gap-1.5 sm:gap-2 px-3.5 sm:px-4 py-1.5 rounded-full bg-[#1A1210]/70 backdrop-blur-md border border-[#E7C878]/30 text-[#E7C878] text-[11px] sm:text-xs font-semibold shadow-xs">
              <Sparkles className="w-3.5 h-3.5 text-[#E7C878]" />
              <span>{language === 'bn' ? 'শুভ বিজয়ার সম্ভাষণ' : 'Subho Bijoya Benediction'}</span>
            </div>

            <h2 className="text-2xl sm:text-4xl md:text-6xl font-extrabold font-serif text-[#E7C878] tracking-tight drop-shadow-md">
              “আসছে বছর আবার হবে…”
            </h2>

            <p className="text-xs sm:text-base text-[#FFF8EA]/80 leading-relaxed max-w-xl mx-auto font-sans">
              {language === 'bn'
            ...
            <div className="pt-2 flex flex-col sm:flex-row items-center justify-center gap-3">
              <Link
                href="/bijoya"
                className="apple-btn-primary w-full sm:w-auto px-7 sm:px-8 py-3 sm:py-3.5 flex items-center justify-center gap-2 text-xs sm:text-sm cursor-pointer shadow-lg"
              >
